                ...
                <ul class="list">
                   ...
                   <!-- <li><a href="javascript:void(0);" class="menu-toggle"><i class="fa fa-mortar-board" ></i><span>Head Faculty</span> </a>
                    ...
                    <li><a href="javascript:void(0);" class="menu-toggle"><i class="fa fa-group"></i><span>Group</span> </a>
                        <ul class="ml-menu">
                            <li><a href="grp_allocate.php">Allocate Groups</a></li>
                            <li><a href="allocated_group.php">Manage Allocated Groups</a></li>
                            <!-- <li><a href="profile.html">Profile</a></li> -->
                        </ul>
                    </li>
                    <li><a href="add_progress_title.php"><i class="fa fa-list" style="font-size:20px;"></i><span>Manage Titles</span></a></li>

                    <li><a href="javascript:void(0);" class="menu-toggle"><i class="fa fa-calendar"></i><span>Schedules</span> </a>
                        <ul class="ml-menu">
